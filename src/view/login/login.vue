    ...
    <div v-loading="loading" class="form-box" element-loading-background="rgba(0, 0, 0, 0)">
      ...
      <form class="login-form" autocomplete="off" @submit.prevent="throttleLogin()">
        <div class="form-item nickname">
          ...
          <input v-model="form.username" type="text" autocomplete="off" placeholder="请填写用户名">
        </div>
        <div class="form-item password">
          <span class="icon secret-icon" />
          <input v-model="form.password" type="password" autocomplete="off" placeholder="请填写用户登录密码">
        </div>
