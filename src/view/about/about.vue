      ...
      <div class="lin-info-right">
        <div class="team-detail">
          <div class="team-box">
            ...
            <ul class="team-ul">
              <li>
                <span class="shadow-box"> <i class="team-shadow" /> </span> <span class="team-role">策划</span>
                <span class="team-name">七月</span>
              </li>
              <li>
                <span class="shadow-box"> <i class="team-shadow" /> </span> <span class="team-role">研发</span>
              ...
              <li>
                <span class="shadow-box"> <i class="team-shadow" /> </span> <span class="team-role">设计</span>
            ...
            <div class="article-detail">
              ...
              <div class="article-tool">
                ...
                <div class="article-about">
                  <span><i class="iconfont icon-shoucang" />37</span>
                  <el-divider direction="vertical" />
                  <span><i class="iconfont icon-pinglun" />2384</span>
                  <el-divider direction="vertical" />
                  <span><i class="iconfont icon-fenxiang" />56</span>
                </div>
              </div>
            </div>
          </div>
