<template>
  <div class="container">
    <div class="header">
      ...
      <!-- 分组选择下拉框 -->
      <el-select v-model="group_id" size="medium" filterable placeholder="请选择分组" clearable @change="handleChange">
      ...
      <div style="margin-top:-25px;">
        <el-tabs v-model="activeTab" @tab-click="handleClick">
          ...
          <el-tab-pane label="修改密码" name="修改密码">
            <user-password :id="id" ref="password" class="password" @handlePasswordResult="handlePasswordResult" />
          </el-tab-pane>
        </el-tabs>
      </div>
      <!-- 按键操作 -->
