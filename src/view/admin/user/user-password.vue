  ...
  <div class="container">
    ...
    >
      <el-form-item label="密码" prop="new_password">
        <el-input v-model="form.new_password" size="medium" clearable type="password" autocomplete="off" />
      </el-form-item>
      <el-form-item label="确认密码" prop="confirm_password" label-position="top">
        <el-input v-model="form.confirm_password" size="medium" clearable type="password" autocomplete="off" />
      </el-form-item>
