  ...
  <div class="user">
      ...
      <el-dropdown-menu slot="dropdown" class="user-box">
        <div class="user-info">
          <div class="avatar" title="点击修改头像">
            ...
            <label class="mask">
              <i class="iconfont icon-icon-test" style="font-size: 20px;" />
              <input ref="avatarInput" type="file" accept="image/*" @change="fileChange">
            </label>
          </div>
          <div class="text">
            <div v-if="!nicknameChanged" class="username" @click="changeNickname">{{ nickname }}</div>
            <el-input
              v-else
              ref="input"
              v-model="nickname"
        ...
        <ul class="dropdown-box">
          <li class="password" @click="goToCenter">
            <i class="iconfont icon-weibaoxitongshangchuanlogo-" /> <span>个人中心</span>
          </li>
          <li class="account" @click="outLogin"><i class="iconfont icon-tuichu" /> <span>退出账户</span></li>
        </ul>
      </el-dropdown-menu>
    </el-dropdown>
    <!-- 修改头像 -->
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" @click="cropVisible = false">取 消</el-button>
