    ...
    <div class="table-main">
      ...
      >
        ...
        <template v-for="item in filterTableColumn">
          <!-- 自定义排序 -->
          <el-table-column v-if="item.label === '排序'" :key="item.label" label="排序">
            <template slot-scope="props">
              <input
          ...
          >
            <template slot-scope="props">
              <div v-if="!props.row.editFlag" class="table-edit">
                ...
                <div class="cell-icon" @click="handleCellEdit(props.row)"><i class="el-icon-edit" /></div>
              </div>
              <div v-else class="table-edit">
                <el-input v-model="props.row.remark" placeholder />
                <div class="cell-icon-edit">
                  <div class="cell-save" @click="handleCellSave(props.row)"><i class="el-icon-check" /></div>
                  <div class="cell-cancel" @click="handleCellCancel(props.row)"><i class="el-icon-close" /></div>
                </div>
              </div>
            </template>
          </el-table-column>
          <!-- 推荐 -->
          <el-table-column v-if="item.label === '推荐'" :key="item.label" label="推荐">
            <template slot-scope="props">
              <el-switch
