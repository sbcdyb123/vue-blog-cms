  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div class="block">
            ...
            <el-rate v-model="value1" :colors="colors1" :max="6" />
          </div>
          <div class="block">
            <span class="demonstration">区分颜色</span>
            <el-rate v-model="value2" :colors="colors2" />
          </div>
        </el-row>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row> <el-rate v-model="value3" show-text :texts="texts" :colors="colors3" /> </el-row>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <el-rate v-model="value4" disabled show-score text-color="#ff9900" score-template="{value}分" />
        </el-row>
