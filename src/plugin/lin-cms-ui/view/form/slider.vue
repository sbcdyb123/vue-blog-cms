  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block"><el-slider v-model="value8" show-input /></div>
          </template>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block"><el-slider v-model="value9" range show-stops :max="10" /></div>
          </template>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block"><el-slider v-model="value10" vertical height="200px" /></div>
          </template>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <template>
            <div class="block"><el-slider v-model="value11" range :marks="marks" /></div>
          </template>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
