  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col :span="12"> <el-input v-model="input1" placeholder="请输入内容" size="medium" /> </el-col>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col :span="12"> <el-input placeholder="禁止输入" size="medium" disabled /> </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-col :span="12">
            <el-input v-model="input2" placeholder="请输入内容" size="medium" suffix-icon="el-icon-edit" />
          </el-col>
        </el-row>
        <el-row style="margin-top:20px">
          <el-col :span="12">
            <el-input v-model="input3" placeholder="请输入内容" size="medium" prefix-icon="el-icon-search" />
          </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-input v-model="input6" placeholder="请输入内容" suffix-icon="el-icon-date" />
          </el-col>
          <el-col :span="6">
            <el-input v-model="input7" size="medium" placeholder="请输入内容" suffix-icon="el-icon-date" />
          </el-col>
          <el-col :span="6">
            <el-input v-model="input8" size="small" placeholder="请输入内容" suffix-icon="el-icon-date" />
          </el-col>
          <el-col :span="6">
            <el-input v-model="input9" size="mini" placeholder="请输入内容" suffix-icon="el-icon-date" />
          </el-col>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
