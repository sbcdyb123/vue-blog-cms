  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
        ...
        <el-row>
          <el-col>
            ...
            <div class="block">
              ...
              <el-cascader v-model="selectedOptions2" expand-trigger="hover" :options="options" @change="handleChange" />
            </div>
          </el-col>
        </el-row>
        <el-collapse>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <span class="demonstration">通过在数据源中设置 disabled 字段来声明该选项是禁用的</span>
            <el-cascader :options="optionsWithDisabled" />
          </div>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <span class="demonstration">可以仅在输入框中显示选中项最后一级的标签，而不是选中项所在的完整路径。</span>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div><el-cascader v-model="selectedOptions3" :options="options1" /></div>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <span class="demonstration">点击或移入选项即表示选中该项，可用于选择任意一级菜单的选项。</span>
      ...
      <el-card style="margin-bottom:50px;">
        ...
        <el-row>
          <div>
            <span class="demonstration">当选中某一级时，动态加载该级下的选项。</span>
            <el-cascader :options="options2" :props="props" @active-item-change="handleItemChange" />
          </div>
        </el-row>
        <el-collapse>
          <el-collapse-item title="查看代码" name="2">
