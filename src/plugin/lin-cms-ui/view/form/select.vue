  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap-ui">
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value3" size="medium" clearable placeholder="请选择">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value4" size="medium" multiple placeholder="请选择">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-row>
        <el-collapse>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row>
          <el-select v-model="value6" placeholder="请选择">
            <el-option-group v-for="group1 in options3" :key="group1.label" :label="group1.label">
              <el-option v-for="item in group1.options" :key="item.value" :label="item.label" :value="item.value" />
            </el-option-group>
          </el-select>
        </el-row>
        <el-collapse>
