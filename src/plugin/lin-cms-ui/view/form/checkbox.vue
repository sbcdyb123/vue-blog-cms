          ...
          <el-col :span="12">
            ...
            <div style="margin-top: 20px">
              <el-checkbox-group v-model="checkboxGroup3" size="small">
                <el-checkbox-button v-for="city in cities" :key="city" :label="city" :disabled="city === '北京'">{{
                  city
                }}</el-checkbox-button>
              </el-checkbox-group>
            </div>
      ...
      <el-card class="box-card" style="margin-bottom:50px;">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            <div style="margin-top: 20px">
              <el-checkbox v-model="checked3" label="备选项1" border size="medium" />
              <el-checkbox v-model="checked4" label="备选项2" border size="medium" />
            </div>
            <div style="margin-top: 20px">
              <el-checkbox-group v-model="checkboxGroup5" size="small">
                <el-checkbox label="备选项1" border />
                <el-checkbox label="备选项2" border disabled />
              </el-checkbox-group>
            </div>
            <div style="margin-top: 20px">
