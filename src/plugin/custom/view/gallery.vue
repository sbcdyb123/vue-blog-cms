  ...
  <div class="lin-container">
    ...
    <div class="lin-wrap container">
      <div class="imgs-upload-container">
        <div v-for="(url, index) in thumbs" :key="index" class="img-box" @click="preview(index)">
          <el-image class="thumb-item-img" :src="url" fit="cover" style="width: 100%; height: 100%;" />
          <div class="control">
            <div class="preview"><i class="el-icon-view" /></div>
          </div>
        </div>
      </div>
    </div>
